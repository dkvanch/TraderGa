...
begin
  AnaliticObject:= TAnaliticObject.Create;
  AnaliticObject.Month_ID:= AMonth_ID;
  AnaliticObject.Shop_ID:= AShop_ID;
  AnaliticObject.Kind_ID:= AKind_ID;
  AnaliticObject.Product_ID:= AProduct_ID;
  AnaliticObject.Concurent_ID:= AConcurent_ID;
  result:= AnaliticObject;
end;
